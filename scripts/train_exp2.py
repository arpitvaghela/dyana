...
class Step:
    ...
    def get_command_str(self, run_path: str):
        ...
        id = run_path.split("/")[-1]
        cmd += f"--logdir ./logs/{id} --batchsize 0 --weight_decay 0.001 "# --weight_decay_kind to_init "
        if self.n_layers:
...
for datapct in datapct_range:
    steps1_5 = [
        ...
        Step(2, 4, 8, datapct, 2_500, math_operator="s5", load_path="final_8_2_1.pt"),
        Step(3, 4, 8, datapct, 5_000, math_operator="s5", load_path="final_8_4_2.pt"),
	...
	Step(2, 4, 16, datapct, 10_000, math_operator="s5", load_path="final_16_4_1.pt"),
        Step(
            2, 4, 32, datapct, 15_000, math_operator="s5", load_path="final_16_4_2.pt"
        ),
        Step(
